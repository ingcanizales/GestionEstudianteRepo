    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MateriasXEstudiante", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MateriasXEstudiante_EstadoMateria_EstadoId",
                        column: x => x.EstadoId,
                        principalSchema: "GE",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MateriasXEstudiante_Estudiante_EstudianteId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MateriasXEstudiante_Materia_MateriaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MateriasXEstudiante_EstadoId",
                schema: "GE",
                table: "MateriasXEstudiante",
                column: "EstadoId");

            migrationBuilder.CreateIndex(
                name: "IX_MateriasXEstudiante_EstudianteId",
                schema: "GE",
                table: "MateriasXEstudiante",
                column: "EstudianteId");

            migrationBuilder.CreateIndex(
                name: "IX_MateriasXEstudiante_MateriaId",
                schema: "GE",
                table: "MateriasXEstudiante",
                column: "MateriaId");
